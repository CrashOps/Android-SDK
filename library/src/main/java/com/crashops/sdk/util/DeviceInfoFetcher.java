...
public class DeviceInfoFetcher {
  ...
  private static String getCarrierName() {
    TelephonyManager manager = (TelephonyManager) CrashOps.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    String carrierName;
    if (manager != null) {
  ...
  public static int getDeviceBatteryPercentageLevel() {
    ...
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
      BatteryManager batteryManager = (BatteryManager) CrashOps.getApplicationContext().getSystemService(BATTERY_SERVICE);
  ...
  static private String getAndroidId() {
    ...
    if (appContext != null) {
      ...
      SdkLogger.error(TAG, "This should never happen...");
      return "";
    }
  }
